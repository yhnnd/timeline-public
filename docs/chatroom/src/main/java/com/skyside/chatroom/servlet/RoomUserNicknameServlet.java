...
@WebServlet("/room-user-nickname")
public class RoomUserNicknameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (sessionid == null || userid != WebSocket.getUserIdBySessionId(sessionid)) {
            ...
            UserAndRoom userAndRoom = userAndRoomDAO.getUserAndRoomByUseridAndRoomid(roomUserId, roomId);
